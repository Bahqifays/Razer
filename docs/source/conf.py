...
# razer_settlement documentation build
...
from razer_settlement import __version__ as release

# -- Project information -----------------------------------------------------

project = "razer_settlement"
author = "Kedro"
...
htmlhelp_basename = "razer_settlementdoc"
...
latex_documents = [
    (
        master_doc,
        "razer_settlement.tex",
        "razer_settlement Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "razer_settlement",
        "Project razer_settlement codebase.",
        "Data-Science",
    )
]
